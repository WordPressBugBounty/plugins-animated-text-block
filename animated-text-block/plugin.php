...
if (! defined('ABSPATH')) {
	...
	define('ATB_VERSION', isset($_SERVER['HTTP_HOST']) && 'localhost' === $_SERVER['HTTP_HOST'] ? time() : '1.0.8');
...
<?php
			...
			function adminEnqueueScripts()
			{
				...
				if (isset($screen->base) && $screen->base === 'animated-text-block_page_atb_demo_page') {
					...
					wp_enqueue_script('atb-admin-help', ATB_DIR_URL . 'build/admin-help.js', ['react', 'react-dom', 'wp-components', 'fs'], ATB_VERSION, true);
