...
const Settings = ({ attributes, setAttributes, isPremium, siteURL }) => {
	...
	return <>
			...
			<TabPanel className='bPlTabPanel' activeClass='activeTab' tabs={generalStyleTabs} onSelect={tabController}>{tab => <>
				...
				{'style' === tab.name && <>
					<PanelBody className='bPlPanelBody' title={__('Animated Text', 'animated-text-block')}>
						...
						{
							("default" === theme || "type1" === theme || "type2" === theme || "type4" === theme || "type5" === theme || "type6" === theme || "type7" === theme || "type8" === theme || "type10" === theme) && <ColorControl label={__('Color:', 'animated-text-block')} value={color} onChange={val => setAttributes({ color: val })} />
						}
		...
		<AboutProModal isProModalOpen={isProModalOpen} setIsProModalOpen={setIsProModalOpen} link={siteLocation}>
			<li>&emsp;<strong>{__('Choose Your Preferred Theme: ', 'animated-text-block')}</strong>{__('Select the theme of your choice to personalize your experience and give your website the look and feel that suits your style.', 'animated-text-block')}</li>
			<li>&emsp;<strong>{__('Understanding Text Alignment: ', 'animated-text-block')}</strong>{__('Text alignment controls the positioning of text, improving readability and design balance.', 'animated-text-block')}</li>
			<li>&emsp;<strong>{__('Max-Width animation layouts: ', 'animated-text-block')}</strong>{__('Max-width sets the maximum width of an element, ensuring responsive and flexible layouts.', 'animated-text-block')}</li>
			<li>&emsp;<strong>{__('Enhancing Design with Text-Shadow: ', 'animated-text-block')}</strong>{__('Text-shadow adds depth and contrast to text by applying shadow effects, improving readability and aesthetics.', 'animated-text-block')}</li>
			<li>&emsp;<strong>{__('Optimizing Animation Speed: ', 'animated-text-block')}</strong>{__('Animation speed controls the duration of transitions, affecting user experience and visual smoothness.', 'animated-text-block')}</li>
			<li>&emsp;<strong>{__('Mastering Perspective Depth Control: ', 'animated-text-block')}</strong>{__('Perspective depth control adjusts the 3D depth effect, enhancing realism in visual designs.', 'animated-text-block')}</li>
			<li>&emsp;<strong>{__('Understanding Transform Origin: ', 'animated-text-block')}</strong>{__('Transform origin defines the pivot point for transformations, affecting scaling, rotation, and skewing.', 'animated-text-block')}</li>
			<li>&emsp;<strong>{__('Show/Hide Oscillation Effects: ', 'animated-text-block')}</strong>{__('Oscillation creates a smooth, back-and-forth movement, often used to add dynamic motion to elements in design.', 'animated-text-block')}</li>
			<li>&emsp;<strong>{__('Controlling Repeat Behavior in Animations: ', 'animated-text-block')}</strong>{__('Repeat behavior controls how animations loop, defining whether they restart, alternate, or stop after completing.', 'animated-text-block')}</li>
			<li>&emsp;<strong>{__('Adjusting Repeat Delay Speed: ', 'animated-text-block')}</strong>{__('Repeat delay speed sets the time interval between animation cycles, creating a pause before the animation restarts.', 'animated-text-block')}</li>
			<li>&emsp;<strong>{__('Exploring Animation Effects: ', 'animated-text-block')}</strong>{__('Animation effects enhance user interaction by adding dynamic movements and transitions to elements on a webpage or interface.', 'animated-text-block')}</li>
			<li>&emsp;<strong>{__('Applying Random Text Color: ', 'animated-text-block')}</strong>{__('Random text color changes the color of text dynamically, creating visual variety and interest in designs.', 'animated-text-block')}</li>
			<li>&emsp;<strong>{__('Applying Forward Font Stretch: ', 'animated-text-block')}</strong>{__('Forward font stretch adjusts the horizontal spacing of characters, making text wider or narrower for enhanced readability or style.', 'animated-text-block')}</li>
			<li>&emsp;<strong>{__('Adjusting Animation Duration: ', 'animated-text-block')}</strong>{__('Animation duration defines the length of time an animation takes to complete, influencing the speed and smoothness of the effect.', 'animated-text-block')}</li>
			<li>&emsp;<strong>{__('Show/Hide Animation Repeat: ', 'animated-text-block')}</strong>{__('Infinite animation repeat ensures an animation loops continuously, creating a never-ending effect without stopping.', 'animated-text-block')}</li>
		</AboutProModal>
	</>;
};
